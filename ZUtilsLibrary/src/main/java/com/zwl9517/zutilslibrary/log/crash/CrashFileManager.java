...
import com.zwl9517.zutilslibrary.file.FileUtil;
import com.zwl9517.zutilslibrary.file.IOUtil;
import com.zwl9517.zutilslibrary.StringUtil;
...
import static com.zwl9517.zutilslibrary.constant.ConstantAppInfo.CRASH_LOG_FILE_PATH;
...
public class CrashFileManager {
    ...
    private static void saveStackTrace(Context context, boolean uncaught, String stackTrace) {
        ...
        try {
            File mFile = new File(CRASH_LOG_FILE_PATH + File.separator
    ...
    private static int getTodayCrashCount(File file) {
        ...
        try {
            ...
            String ex = IOUtil.read(fileReader);
    ...
    public static void deleteAllCrashLog() {
        String crashLogFile = CRASH_LOG_FILE_PATH;
